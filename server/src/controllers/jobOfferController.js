                ...
                if (jobOffer) {
                    ...
                    db.JobOffer.create({
                        ...
                        .then((jobOffer) => {
                            ...
                            res.status(201).json({
                                message: 'Oferta de trabajo creada',
                                jobOffer
            ...
            .then((jobOffer) => {
                if (jobOffer) {
                    db.JobOffer.update({
                        ...
                        .then(() => {
                            console.log('JobOffer has been update');
                            return res.status(201).json(
                                {
                                    message: 'JobOffer has been update',
                                    jobOffer
                                });
                        })
                        .catch(function (error) {
                            console.log("Not possible to update jobOffer", error);
                            return res.status(400).json(
                                {
                                    message: 'Not possible to update jobOffer',
                                    error
                                }
                            );
                        })
                    ...
                    db.JobOffer.destroy({
                        ...
                        .catch(function (error) {
                            ...
                            return res.status(401).json(
                                {
                                    message: "No se pudo borar la oferta de trabajo de nuestra base de datos",
                                    error
                                })
                        })
                }
